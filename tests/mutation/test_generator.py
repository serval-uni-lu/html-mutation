...
from html_mutation.mutation.operator import ChangeTextOperator, Mutant, Validity
...
def test_generator():
    ...
    generator = MutantGenerator(get_simple_dom(), TrueValidator, CsvPersistence, {"filename": filename}, {ChangeTextOperator()})
    generator.execute()

    #TODO: read the content of the generated file to make sure it contains what it should
